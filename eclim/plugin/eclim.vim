...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/seyz/.eclipse/org.eclipse.platform_3.7.0_155965261/plugins/org.eclim_1.7.6'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/seyz/.eclipse/org.eclipse.platform_3.7.0_155965261'
  if has('win32unix')
